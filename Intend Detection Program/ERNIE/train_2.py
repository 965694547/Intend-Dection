...
parser.add_argument("--save_dir", default='./checkpoint/snips', type=str, help="The output directory where the model checkpoints will be written.")
...
parser.add_argument("--valid_steps", default=400, type=int, help="The interval steps to evaluate model performance.")
parser.add_argument("--save_steps", default=400, type=int, help="The interval steps to save checkppoints.")
parser.add_argument("--logging_steps", default=400, type=int, help="The interval steps to logging.")
...
def do_train():
    ...
    test_data_loader = create_dataloader(
        ...
        batchify_fn=batchify_fn,
        trans_fn=trans_func)
    evaluate(best_model, criterion, metric, test_data_loader)
    ...
    print("Train Time: %.4f s" % (train_time))
    print("Test Time: %.4f s" % (test_time))
