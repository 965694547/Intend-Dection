from make_dict import word_dict, intent_dict
import torch 
...
class intent_enc(nn.Module):
    def __init__(self, embedding_size, lstm_hidden_size, vocab_size=len(word_dict)):
        ...
        self.lstm = nn.LSTM(input_size=embedding_size, hidden_size= lstm_hidden_size, num_layers=1,\
                            bidirectional= True, batch_first=True, dropout=DROPOUT)
