...
#parser.add_argument('--data_dir', '-dd', type=str, default='data/dh_nh')
parser.add_argument('--save_dir', '-sd', type=str, default='save')
parser.add_argument("--random_state", '-rs', type=int, default=0)
parser.add_argument('--num_epoch', '-ne', type=int, default=0)
...
if __name__ == "__main__":
    ...
    model = ModelManager(
        args, len(dataset.word_alphabet),len(dataset.intent_alphabet))
    model.show_summary()
    ...
    print('Train time: {:.6f} seconds'.format(end-start))
