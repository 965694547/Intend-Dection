...
for epoch in range(epoch_num):
    ...
    for batch_index, data in enumerate(utils.get_batch(train_data)):
        ...
        intent_logits = intent_model.dec(hi, real_len)
    ...
    for batch_index, data_test in enumerate(utils.get_batch(test_data, batch_size=1)):
        ...
        # Intent
        intent_logits_test = intent_model.dec(hi_test, real_len_test)
...
for batch_index, data in enumerate(utils.get_batch(train_data, batch_size=1)):
